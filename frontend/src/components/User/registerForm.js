...
const RegisterForm = () => {
    ...
    return (_jsxs("div", { className: "relative min-h-screen flex items-center justify-center", children: [_jsx("img", { src: "/backgrnd mvlog.jpg", className: "absolute inset-0 w-full h-full object-cover", alt: "Background" }), _jsx("div", { className: "absolute inset-0 bg-black opacity-50" }), _jsxs("div", { className: "relative z-10 w-full max-w-fit p-8 bg-transparent backdrop-blur-md rounded-2xl shadow-lg border flex-col m-8 items-center justify-center border-gray-500", children: [_jsx("h1", { className: "text-2xl font-bold text-red-500", children: "Welcome to Movie Ticket Booking" }), _jsx("h2", { className: "text-xl font-bold text-center text-amber-400 mt-8", children: "Register Form" }), _jsxs("form", { id: "registerForm", className: "mt-12", onSubmit: handleSubmit, children: [_jsx("input", { type: "text", placeholder: "Name", value: name, onChange: (e) => setName(e.target.value), className: "w-full mx-8 px-8 py-2 min-h-12 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 mt-4" }), _jsx("input", { type: "email", placeholder: "Email", value: email, onChange: (e) => setEmail(e.target.value), className: "w-full px-8 py-2 min-h-12 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 mt-4" }), _jsx("input", { type: "number", placeholder: "Mobile", value: mobile, onChange: (e) => setMobile(e.target.value), className: "w-full px-8 py-2 min-h-12 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 mt-4" }), _jsx("input", { type: "password", placeholder: "Password", value: password, onChange: (e) => setPassword(e.target.value), className: "w-full px-8 py-2 min-h-12 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 mt-4" }), _jsx("input", { type: "password", placeholder: "Confirm Password", value: confirmPass, onChange: (e) => setConfirmPass(e.target.value), className: "w-full px-8 py-2 min-h-12 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 mt-4" }), _jsx("button", { type: "submit", className: "mt-8 bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700", children: "Register" }), _jsx("caption", { onClick: getLogin, className: "mt-4 text-white cursor-pointer hover:underline", children: "Have an account? Login" })] })] })] }));
};
export default RegisterForm;
