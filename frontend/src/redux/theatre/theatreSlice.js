...
//googleLogin,
forgotPass, resetPass, theatreVerify, newPassVerify, 
//logout,
resendOtp, addMoviesToScreen, CompleteTheatreProfile, AddScreen, listScreen, fetchMovies, saveTierData, updateScreen, saveMoviesToShowtime, removeShowtime, deleteEnrolledMovie } from './theatreThunk';
import { toast } from 'sonner';
// Load initial state from localStorage
const user = JSON.parse(localStorage.getItem('theatre') || 'null');
...
const theatreSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            state.message = action.payload.message;
            //state.screens=action.payload.screenData
            state.screens = state.screens.map(screen => screen._id === action.payload.screenData._id ? action.payload.screenData : screen);
            ...
            state.screens = state.screens.map((screen) => (screen._id == updatedScreenData._id ? updatedScreenData : screen));
            toast.success(state.message);
        })
            ...
            state.screens = state.screens.map((screen) => screen._id === updatedScreen._id ? updatedScreen : screen);
            toast.success(state.message);
        })
