...
export const getNowShowingMovies = async (params) => {
    try {
...
export const fetchTheatreData = async (latitude, longitude) => {
    try {
...
export const movieInWishList = async ({ userId, movieId }) => {
    try {
...
export const removeMovieFromWishlist = async ({ userId, movieId }) => {
    try {
...
export const favouritesUserMovies = async (userId) => {
    try {
...
export const newMovieRating = async ({ userId, movieId, rating }) => {
    try {
